...
/*
  ...
  Soverom_intercace_styringV2.2 for ESP32 Devkit Ver.4
...
bool DEBUG = 0;//Aktivere/deaktiverer seriellkommunikkasjonen og debug-meldinger til seriell-konsollen
...
//Denne gjør det samme som funksjonen lyspaa_automatisk2, bare trinnløst med map-funksjonen
...
void motorstep(){//Styrer åpning/lukking av vindu på soverom automatisk, eller via kontrolleren via CoT signalet "Vindusstyring"
