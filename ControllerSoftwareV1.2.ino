...
//Tokens for soverom1 Rekkefølgen i arrays er soverom 1 til 6 (0-5 i array-posisjoner)
const char *token[] = {"eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiI1NDg5In0.BM73ysSfKKQDToNknonEI2KzO7oKwHQjLKUKIz9omyg",
...
//Kays for soverom1 Rekkefølgen i arrays er soverom 1 til 6 (0-5 i array-posisjoner)
const char *order_key_LED[]= {"18663","19296","30697","9926","12023","26810"}; //nøkkel-informasjon til lysstyrke 0
const char *order_key_LUX[] = {"13426","8977","2286","18680","17797","26308"}; //nøkkel-informasjon til lux-måler 1
const char *order_key_temp[] = {"28604","26509","12095","19020","30379","32180"};//nøkkel-informasjon til temperatur-måler 2
const char *order_key_hum[] = {"31117","20272","30736","16555","18177","8618"};//nøkkel.inforamasjon til humidity-måler 3
const char *order_key_CO2[] = {"30290","9148","12201","25687","6944","15591"};//nøkkel.informasjon til CO2 sensor 4
const char *order_key_PIR[] = {"20999","18540","24524","481","5485","12822"};//nøkkel.inforamasjon til PIR deteksjon 5
const char *order_key_onsketTemp[] = {"25901","18399","19772","19704","10205","22658"};//nøkkel.inforamasjon til ønsket temp 6
const char *order_key_takvifte[] = {"17916","11119","16288","13744","2396","17719"};//nøkkel.inforamasjon til takvifte 7
const char *order_key_lysautomatisk[] = {"10503","17268","15673","17304","9231","14540"};//nøkkel.inforamasjon til av/på for automatisk styring av lys 8
const char *order_key_Vindu[] = {"15838","32767","30604","3094","1703","32123"};//nøkkel.informasjon til Vindusmotor/Stepper Åpent/Lukket 9
