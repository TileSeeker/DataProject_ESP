...
#define H_Bridges_EN 19 // Enables all four outputs on H-Bridge1 and H-bridge2
...
char ssid[] = "SPLITTERPINE";//"Telenor7233lut"; // Navn på ruter
char password[] = "Proteus2X";//"Tappingen2Sponsorkontrakt0"; //Passord på ruter
...
void setup() {
  ...
  digitalWrite(H_Bridges_EN, HIGH);
